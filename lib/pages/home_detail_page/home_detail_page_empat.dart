...
class DetailPageEmpat extends StatefulWidget {
  const DetailPageEmpat({Key? key}) : super(key: key);

  @override
  _DetailPageState createState() => _DetailPageState();
}

class _DetailPageState extends State<DetailPageEmpat> {
      ...
      body: Stack(
        children: [
          ...
          Container(
            ...
            child: Image.asset(
              'assets/images/risol_detail$currentIndex.png',
            ),
          ),
          GestureDetector(
            onTap: () {
