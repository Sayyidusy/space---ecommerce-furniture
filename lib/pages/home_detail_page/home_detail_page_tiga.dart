...
class DetailPageTiga extends StatefulWidget {
  const DetailPageTiga({Key? key}) : super(key: key);

  @override
  _DetailPageState createState() => _DetailPageState();
}

class _DetailPageState extends State<DetailPageTiga> {
      ...
      body: Stack(
        children: [
          ...
          Container(
            ...
            child: Image.asset(
              'assets/images/pastel_detail$currentIndex.png',
            ),
          ),
          GestureDetector(
            onTap: () {
